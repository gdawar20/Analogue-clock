...
float angleHour = 0, angleMin = 0, angleSec = 0, clockR = 80.0f, angle1min = 3.14159265358979323846 / 30.0f, minStart = 0.9f, minEnd = 1.0f, stepStart = 0.8f, stepEnd = 1.0f;
void init() {
...
void Display() {
	...
	for (int i = 0; i < 60; i++) {
		...
		if (i % 5) { // normal minute
			...
			//The following is to draw green long lines around the circle
